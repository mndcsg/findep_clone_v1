...
const Social = () => {
  ...
  const mainContent = [
    ...
    [
      ...
      { text: ', gracias a las aportaciones de nuestros colaboradores y Grupo company name, demostrando nuestro compromiso con la generación de un futuro más justo para la juventud.', highlight: false }
    ],
    [
