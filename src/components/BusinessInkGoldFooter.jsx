    ...
    <footer style={styles.footer}>
      ...
      <div style={styles.column}>
        ...
        <div style={styles.column}>
          ...
          <p style={styles.addressText}>Prol. Paseo de la Reforma 600 - 420, Col. Santa Fe Peña Blanca, CDMX.</p>
          <p style={styles.addressText}>+52 55 5229 0200</p>
          <p style={styles.addressText}>company name_ir@company name.com.mx</p>
        </div>
      </div>
      
      <div style={styles.bottomBar}>
        <span>© 2026 company name. All Rights Reserved.</span>
        <span>Powered by PixelSiete</span>
      </div>
    </footer>
  );
};
